...
{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/vQZsz6.jpg" >}}
...
{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/nrjtxY.jpg" >}}

如果 leader 被整个集群都隔离了，这时 leader 的 `majority` 为 1，无法发起选举，leader 就会将自己的状态切换为 follower，影响到了集群的可用性。

{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/Q1Q85l.jpg" >}}
...
{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/wxLVur.jpg" >}}

如果新节点与 leader 不在同一区域内，并且集群被对半隔离，这时任何一侧的 majority 都不是 `3`，从而会发生重新选举，leader 将状态切换为 follower。

{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/Ut8AMy.jpg" >}}
...
{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/Qdb3Tc.jpg" >}}
...
{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/O14t4z.jpg" >}}
...
{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/PerGyj.jpg" >}}
...
{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/wujUeA.jpg" >}}
...
{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/Z8WfV9.jpg" >}}

当 `Learner` 节点与 leader 保持同步之后，可以通过 `member promote` 来将该节点的状态提升为 follower，然后将其计入 quorum 的大小之中。

{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/YAYapJ.jpg" >}}

leader 会验证 `promote` 请求来确保其操作的安全性。只有当 learner 的 log 数据与 leader 保持一致后，learner 才能被提升为 follower 节点。

{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/nm280k.jpg" >}}
...
{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/Qx4gns.jpg" >}}
