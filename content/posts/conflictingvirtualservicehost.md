...
优化方案请参考下文的 [使目标主机唯一](https://fuckcloudnative.io/posts/conflictingvirtualservicehost/#make-the-hostnames-unique)。
...
优化方案请参考下文的 [合并冲突的 VirtualService](https://fuckcloudnative.io/posts/conflictingvirtualservicehost/#merge-the-conflicting-virtualServices)。
