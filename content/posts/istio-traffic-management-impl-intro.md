...
{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/5Zywav.jpg" >}}
...
{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/dCSUXw.jpg" >}}
...
{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/fONobF.jpg" >}}
...
Istio 通过 K8s 的 [Admission webhook](https://fuckcloudnative.io/posts/kubernetes-extensible-admission/) 机制实现了 sidecar 的自动注入，Mesh 中的每个微服务会被加入 Envoy 相关的容器。下面是 `Productpage` 微服务的 Pod 内容，可见除 productpage 之外，Istio 还在该 Pod 中注入了两个容器 `gcr.io/istio-release/proxy_init` 和 `gcr.io/istio-release/proxyv2`。
...
<center>{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/Rwq4zh.jpg" >}}</center>
...
<center>{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/NQTN5a.jpg" >}}</center>
...
<center>{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/3DyRUz.jpg" >}}</center>
...
<center>{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/CBAqAH.jpg" >}}</center>
...
<center>{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/pXRSn3.jpg" >}}</center>
...
<center>{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/yD84dx.jpg" >}}</center>
