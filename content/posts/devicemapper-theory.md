...
{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/wazQIK.jpg" >}}
...
{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/JRQI4L.jpg" >}}
...
+ **`CoW（copy on write）写复制`**：一些文件系统提供的写时复制策略。
  ...
  {{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/Qhtdrp.jpg" >}}
  
  下图所示，当需要删除 file1 时，由于 file1 是镜像层文件，容器层会创建一个 .wh 前置的隐藏文件，从而实现对 file1 的隐藏，实际并未删除 file1，从而保证镜像层数据的完整性和复用性。
  
  {{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/m4tMby.jpg" >}}
...
+ **`Thin-provisioning（精简配置）`**，直译为精简配置。`Thin-provisioning` 是动态分配，需要多少分配多少，区别于传统分配固定空间从而造成的资源浪费。
  ...
  {{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/Dou0uN.jpg" >}}
  
  {{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/lMhtJG.jpg" >}}
  ...
  {{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/udMvqc.jpg" >}}
