...
{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/blog/2019-05-31-%E5%B1%8F%E5%B9%95%E5%BF%AB%E7%85%A7%202019-05-31%20%E4%B8%8B%E5%8D%882.34.00.png" >}}
...
{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/blog/2019-05-31-073421.png" >}}
...
{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/blog/2019-05-31-074727.png" >}}
...
{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/blog/2019-05-31-080449.png" >}}
...
{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/blog/2019-05-31-081526.png" >}}

如果此时停止 `foo.service`，关闭用户 jack 的 sha1sum 进程，你会看到用户 tom 的 sha1sum 进程仍然只能获得 `5%` 左右的 CPU 使用时间。

{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/blog/2019-05-31-081858.png" >}}
...
{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/blog/2019-05-31-090137.png" >}}

再使用用户 `tom` 登录系统，执行命令 `sha1sum /dev/zero`，你会发现用户 tom 的 sha1sum 进程和 foo.service 各使用 1 个 CPU 核：

{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/blog/2019-05-31-090512.png" >}}
