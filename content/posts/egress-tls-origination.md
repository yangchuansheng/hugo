...
此处 `ServiceEntry` 与 Envoy 配置文件的映射关系可以参考我之前的文章 [控制 Egress 流量](https://fuckcloudnative.io/posts/control-egress-traffic/) 中的 **HTTP ServiceEntry 配置深度解析**这一部分，具体细节不再赘述。

{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/service-entry-1.svg" >}}
...
{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/serviceentry2.svg" >}}
