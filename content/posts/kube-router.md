...
<center>{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/sMs3sm.jpg" >}}</center>
...
+ [LVS负载均衡之持久性连接介绍](https://fuckcloudnative.io/posts/lvs-persistent-connection/)
...
可以看到 lvs 的规则条目里多了个 `persistent`，即 lvs 的持久连接，关于 lvs 持久连接的具体内容可以参考我的另一篇博文 [LVS负载均衡之持久性连接介绍](https://fuckcloudnative.io/posts/lvs-persistent-connection/)。
