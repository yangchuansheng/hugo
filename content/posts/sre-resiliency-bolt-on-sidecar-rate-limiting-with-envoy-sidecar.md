...
<center>{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/RgKVkq.jpg" >}}</center>
...
<center>{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/0lUjJX.jpg" >}}</center>

在模拟后台作业期间，对 API 资源 `/slow` 的访问速率达到了每秒 `3500` 个请求，影响到了其他端点和客户端。

<center>{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/a0lsWP.jpg" >}}</center>
...
<center>{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/1t4fwm.jpg" >}}</center>
...
<center>{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/vucp1T.jpg" >}}</center>

<center>{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/nqODKP.jpg" >}}</center>

<center>{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/JE0hom.jpg" >}}</center>
...
<center>{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/mVfHPN.jpg" >}}</center>
...
<center>{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/CTswvz.jpg" >}}</center>
...
<center>{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/h6cYkM.jpg" >}}</center>

通过可视化 API 服务实际看到的请求数量，可以证明请求速率在 `500个请求/秒` 上下波动，这正是我们所期望的！

<center>{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/FHBjiF.jpg" >}}</center>

再查看一下 Envoy 传出的 API 连接，可以看到传出请求速率也在 `500个请求/秒` 上下波动！

<center>{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/F0WQMW.jpg" >}}</center>
