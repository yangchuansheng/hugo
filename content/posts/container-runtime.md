...
{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/7Ds35Y.jpg" >}}
...
{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/4pdror.jpg" >}}

Containerd 内置的 CRI 插件实现了 Kubelet CRI 接口中的 `Image Service` 和 `Runtime Service`，通过内部接口管理容器和镜像，并通过 CNI 插件给 Pod 配置网络。
{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/mCGR3h.jpg" >}}
