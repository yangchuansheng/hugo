...
tags: ["envoy", "科学上网"]
img: "https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/20191228184723.png"
bigimg: [{src: "https://hugo-picture.oss-cn-beijing.aliyuncs.com/blog/2019-04-27-080627.jpg"}]
---

[上篇文章](https://fuckcloudnative.io/posts/file-based-dynamic-routing-configuration/)介绍了如何基于文件系统动态更新 `Envoy` 配置，还没看过的同学可以去恶补一下。今天要介绍一个新的基于 `Envoy` 的奇技淫巧，其实很简单，几句话就可以说完。但鉴于网上并无与此相关的资料，决定还是写出来吧，目测我是用此方法的第一人，至少国内如此。
...
- "@type": type.googleapis.com/envoy.api.v2.Listener
  ...
  filter_chains:
  - filter_chain_match:
      server_names: "google.fuckcloudnative.io"
    transport_socket:
      ...
      typed_config:
        ...
        common_tls_context:
          tls_certificates:
          - certificate_chain:
              filename: "/etc/letsencrypt/live/www.fuckcloudnative.io/fullchain.pem"
            private_key:
              filename: "/etc/letsencrypt/live/www.fuckcloudnative.io/privkey.pem"
    filters:
...
{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/20191228175224.png" >}}

已添加到我的博客首页，快快收藏起来：

{{< figure link="https://hugo-picture.oss-cn-beijing.aliyuncs.com/images/20191228180052.png" >}}
